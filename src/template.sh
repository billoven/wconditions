...
WURL="https://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=ILEDEFRA131&day=1&month=7&year=2018&dayend=31&monthend=7&yearend=2018&graphspan=custom&format=1" 

# Get data and suppress <br> html tag and blank lines
# save in text temporary file
curl  $WURL | sed "/<br>/d" | grep -v '^$' >${tmpdir}/res.txt
