...
<div class="container mt-5">
    ...
    <form method="GET" action="#statistics" id="year-form">
        <div class="form-group">
            ...
            <button class="btn btn-primary" id="fold-all-btn">Fold All</button>
            <button class="btn btn-primary" id="unfold-all-btn">Unfold All</button>
        </div>
        </form>
    ...
    function generateStatTable($type, $statistics, $selected_years) {
        if (!empty($statistics)) {
            ...
            echo "<thead class='text-center'><tr><th></th><th><b style='word-wrap: break-word;'>1971-2000 Normals</b></th><th><b style='word-wrap: break-word;'>2016-2020 Normals</b></th>";
    ...
    <div class="m-4">            <!-- Minimum Climatologic Results -->
        <div id="statistics" class="card">
            <div class="card-header" id="average-heading">
                <p class="mb-0">
                    <a href="#average-collapse" data-bs-toggle="collapse">Average Climatologic Results</a>
                </p>
            </div>
            <div id="average-collapse" class="collapse show" aria-labelledby="average-heading" data-parent="#climatologic-tables">
                <div class="card card-body">
                    <?php !empty($statistics) ? generateStatTable('Average', $statistics, $selected_years) : ''; ?>                                             
                </div>
            </div>
            <!-- Minimum Climatologic Results -->
            <div class="card-header" id="minimum-heading">
                <p class="mb-0">
                    <a href="#minimum-collapse" data-bs-toggle="collapse">Minimum Climatologic Results</a>
                </p>
            </div>
            <div id="minimum-collapse" class="collapse show" aria-labelledby="minimum-heading" data-parent="#climatologic-tables">
                <div class="card card-body">
                    <!-- Table content for minimum climatologic results -->
                    <?php !empty($statistics) ? generateStatTable('Low', $statistics, $selected_years) : ''; ?>
                                
                </div>
            </div>

            <!-- Maximum Climatologic Results -->
            <div class="card-header" id="maximum-heading">
                <p class="mb-0">
                    <a href="#maximum-collapse" data-bs-toggle="collapse">Maximum Climatologic Results</a>
                </p>
            </div>
            <div id="maximum-collapse" class="collapse show" aria-labelledby="maximum-heading" data-parent="#climatologic-tables">
                <div class="card card-body">
                    <?php !empty($statistics) ? generateStatTable('High', $statistics, $selected_years) : '';
 ?>
                </div>
            </div>
            <!-- Rainfall Climatologic Results -->
            <div class="card-header" id="rainfall-heading">
                <p class="mb-0">
                    <a href="#rainfall-collapse" data-bs-toggle="collapse">Rainfall Climatologic Results</a>
                </p>
            </div>
            <div id="rainfall-collapse" class="collapse show" aria-labelledby="rainfall-heading" data-parent="#climatologic-tables">
                <div class="card card-body">
                    <?php !empty($statistics) ? generateStatTable('Rainfall', $statistics, $selected_years) : ''; ?>
                </div>
            </div>
        </div>
    </div>
